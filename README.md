...
- **[`index.html`](./index.html)** — login hub. Register or log in with a username + 4-digit PIN to sync your progress across devices.
...
- Logging in with a username + PIN additionally syncs that data to the cloud, so progress follows you across devices.
